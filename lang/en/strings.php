...
return [
    ...
    'form_mail_hello'                   => 'Hello!',
    'form_mail_taster_msg'              => 'has requested a free taster session via our website. You can reach them using the details they provided below:',
    'form_mail_logo'                    => config('app.url') . config('app.logo'),
